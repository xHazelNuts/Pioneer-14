...
namespace Xilium.CefGlue
{
    ...
    public sealed unsafe partial class CefRequestContext
    {
        ...
        public void SetChromeColorScheme(CefColorVariant variant, CefColor userColor)
        {
            cef_request_context_t.set_chrome_color_scheme(GetSelf(), variant, userColor.ToArgb());
        }
        ...
        /// be called on the browser process UI thread.
        ///
        public CefColorVariant ChromeColorSchemeMode => cef_request_context_t.get_chrome_color_scheme_mode(GetSelf());
        ...
        ///
        public CefColor ChromeColorSchemeColor => new(cef_request_context_t.get_chrome_color_scheme_color(GetSelf()));

        ///
        /// Returns the current Chrome color scheme variant. Must be called on the
        /// browser process UI thread.
        ///
        public CefColorVariant ChromeColorSchemeVariant => cef_request_context_t.get_chrome_color_scheme_variant(GetSelf());
    }
}
