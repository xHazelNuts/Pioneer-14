...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRequestHandler
    {
        ...
        internal void add_ref(cef_request_handler_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
        ...
        internal int release(cef_request_handler_t* self)
        {
            lock (SyncRoot)
            {
                var result = --_refct;
        ...
        internal int has_one_ref(cef_request_handler_t* self)
        {
            lock (SyncRoot) { return _refct == 1 ? 1 : 0; }
        }
        
        internal int has_at_least_one_ref(cef_request_handler_t* self)
        {
